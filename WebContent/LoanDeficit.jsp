...
<title>Loan Deficit Analysis</title>
</head>
<body>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary" style="margin-bottom: 40px">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <ul class="navbar-nav ml-auto" style="padding-right: 50px">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu">
          ...
          <a class="dropdown-item" href="loandeficitanalysis">Analyze Funding</a>
        </div>
      </li>
	...
	<h1>Loan Deficit Analysis</h1>
	<br/>

	<div class="container">
		<div style="width: 45%; float: left; display: block;">
			<h4>Countries with Greatest Loan Deficit</h4>
			<table class="table table-striped">
				...
				<c:forEach items="${resultsCountry}"
					var="resultCountry">
					<tbody>
						<tr>
							<td><c:out value="${resultCountry.getCountry()}" /></td>
                			<td><c:out value="${resultCountry.getPercentFunded()}" /></td>
						</tr>
					</tbody>
				</c:forEach>
			</table>
		...
		<div style="width: 45%; float: right; display: block;">
			<h4>Loan Sectors with Greatest Loan Deficit</h4>
			<table class="table table-striped">
				<thead>
					<tr>
						<th>Sector</th>
				...
				<c:forEach items="${resultsSector}"
					var="resultSector">
					<tbody>
						<tr>
							<td><c:out value="${resultSector.getSector()}" /></td>
                			<td><c:out value="${resultSector.getPercentFunded()}" /></td>
						</tr>
					</tbody>
				</c:forEach>
			</table>
